...
taskkill /FI "WINDOWTITLE eq C:\Windows\system32\cmd.exe - uvicorn  move.main:app --host 0.0.0.0 --port 8005"
...
start cmd /k uvicorn move.main:app --host 0.0.0.0 --port 8005