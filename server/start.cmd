...
taskkill /FI "WINDOWTITLE eq C:\Windows\system32\cmd.exe - uvicorn  inputs.others.main:app --host 0.0.0.0 --port 8003"
...
start cmd /k uvicorn inputs.others.main:app --host 0.0.0.0 --port 8003
